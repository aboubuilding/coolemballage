...
<body class="custom-cursor">
            ...
            <div class="container-fluid">
                <div class="main-header__inner">
                    <div class="main-header__logo">
                        <a href="index.html">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/logo-dark.png" alt="Alefox HTML" width="147">
                        </a>
                    ...
                    <div class="main-slider-one__item">
                        <div class="container">
                            <div class="main-slider-one__content">
                                <h5 class="main-slider-one__sub-title"><span class="sec-title__tagline__left-leaf" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/images/shapes/leaf.png);"></span>Wellcome to <span>Alefox !</span></h5>
                                <!-- slider-sub-title -->
                                <h2 class="main-slider-one__title">
                                    <span class="main-slider-one__title__leaf" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/images/shapes/slider-1-leaf.png);"></span>
                        ...
                        <div class="main-slider-one__layer" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/images/backgrounds/slider-1-1.jpg);"></div><!-- right-image -->
                        <div class="main-slider-one__shape-one"><img src="<?php bloginfo('template_directory'); ?>/assets/images/shapes/slider-1-shape-1.png" alt="alefox"></div><!-- shape-one -->
                        <div class="main-slider-one__shape-two"><img src="<?php bloginfo('template_directory'); ?>/assets/images/shapes/slider-1-shape-2.png" alt="alefox"></div><!-- shape-two -->
                        <div class="main-slider-one__shape-three"><img src="<?php bloginfo('template_directory'); ?>/assets/images/shapes/slider-1-shape-3.png" alt="alefox"></div><!-- shape-one -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-one__image wow fadeInLeft" data-wow-delay="200ms">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/resources/about-1-1.jpg" alt="alefox">
                            <div class="about-one__image__two">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/resources/about-1-2.jpg" alt="alefox">
                            </div>
                ...
                <div class="row gutter-y-30">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="00ms">
                        <div class="service-one__item">
                            ...
                            <div class="service-one__item__image">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/resources/service-1-1.jpg" alt="alefox">
                            </div>
                        </div><!-- /.service-item -->
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="50ms">
                        <div class="service-one__item">
                            ...
                            <div class="service-one__item__image">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/resources/service-1-2.jpg" alt="alefox">
                            </div>
                        </div><!-- /.service-item -->
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="service-one__item">
                            ...
                            <div class="service-one__item__image">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/resources/service-1-3.jpg" alt="alefox">
                            </div>
                        </div><!-- /.service-item -->
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="service-one__bottom__image">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/resources/sb-1.jpg" alt="alefox">
                                    </div>
                                    <div class="col-md-6">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/resources/sb-2.jpg" alt="alefox">
                                    </div>
                                </div>
                            </div>
                        </div>
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="team-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                            <div class="team-card__image">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/team/team-1-1.jpg" alt="Sonia Garcia">
                    ...
                    <div class="item">
                        <div class="team-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            <div class="team-card__image">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/team/team-1-2.jpg" alt="Richard Behler">
                            </div><!-- /.team-card__image -->
                            <div class="team-card__content">
                                <h3 class="team-card__title">
                    ...
                    <div class="item">
                        <div class="team-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            <div class="team-card__image">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/team/team-1-3.jpg" alt="Tony Feingold">
                            </div><!-- /.team-card__image -->
                            <div class="team-card__content">
                                <h3 class="team-card__title">
            ...
            "responsive":{
                ...
                "1200":{
                    ...
                    <div class="client-carousel__one__item">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand/brand-1-1.png" alt="alefox">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/brand/brand-1-1.png" alt="alefox">
                    </div><!-- /.owl-slide-item-->
                    ...
                    <div class="col-xl-6">
                        <div class="alefox-stretch-element-inside-column">
                            <div class="why-choose-one__image wow slideInLeft">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/resources/why-choose-1-1.jpg" alt="alefox">
                    ...
                    <div class="row">
                        <div class="col-lg-6 wow fadeInUp">
                            <div class="offer-one__left">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/resources/offer-1-1.png" alt="alefox">
                                <div class="offer-one__left__off"><span>32%</span>Discounts</div>
                                <div class="offer-one__left__arrow"><img src="<?php bloginfo('template_directory'); ?>/assets/images/shapes/offer-arrow.png" alt="alefox"></div>
                            </div>
                        </div>
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="blog-card__image">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/blog/blog-1-1.jpg" alt="This Leader in Organic Agriculture Growth">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/blog/blog-1-1.jpg" alt="This Leader in Organic Agriculture Growth">
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                            <div class="blog-card__image">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/blog/blog-1-2.jpg" alt="How to Findout Healthy Food For Body">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/blog/blog-1-2.jpg" alt="How to Findout Healthy Food For Body">
                    ...
                    <div class="item">
                        <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                            <div class="blog-card__image">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/blog/blog-1-3.jpg" alt="We Are Ripening Fruits Healthy Blog">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/images/blog/blog-1-3.jpg" alt="We Are Ripening Fruits Healthy Blog">
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="footer-widget footer-widget--about">
                                <a href="index.html" class="footer-widget__logo">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/logo-light.png" width="147" alt="Alefox HTML Template">
                                </a>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="footer-widget footer-widget--blog">
                                ...
                                <ul class="list-unstyled footer-widget__post">
                                    <li>
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/blog/w-1.jpg" alt="alefox">
                                    ...
                                    <li>
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/blog/w-2.jpg" alt="alefox">
                                        <span class="footer-widget__post__date">23 jun 2023</span>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img src="<?php bloginfo('template_directory'); ?>/assets/images/logo-light.png" width="155" alt="" /></a>
            </div>
            <!-- /.logo-box -->
    ...
    <aside class="sidebar-one">
        ...
        <div class="sidebar-one__content">
            ...
            <div class="sidebar-one__logo">
                <a href="index.html" aria-label="logo image"><img src="<?php bloginfo('template_directory'); ?>/assets/images/logo-light.png" alt="Careox HTML" width="147"></a>
